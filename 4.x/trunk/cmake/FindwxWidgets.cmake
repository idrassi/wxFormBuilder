...
# -----------------------------------------------
#
# This is the original cmake 2.8 wxwidget script
# including wxwidget2.9 patch (see bug report)
# .. will be removed when offical fix is available
# -----------------------------------------------
# -----------------------------------------------

 message(STATUS "including custom FindwxWidget.cmake")
...
IF(wxWidgets_FIND_STYLE STREQUAL "win32")
  ...
  MACRO(WX_FIND_LIBS _UNV _UCD _DBG)
    ...
    FOREACH(LIB core adv aui html media xrc dbgrid gl qa richtext stc ribbon propgrid)
      FIND_LIBRARY(WX_${LIB}${_DBG}
        NAMES
