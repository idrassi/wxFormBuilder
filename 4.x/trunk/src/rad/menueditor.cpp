...
: wxDialog( parent, id, _("Menu Editor"), wxDefaultPosition, wxDefaultSize )
{
	...
	m_menuList = new wxListCtrl( this, ID_DEFAULT, wxDefaultPosition, wxDefaultSize,
	...
	wxStaticBoxSizer *sizer1 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Menu item") ), wxVERTICAL );
	wxFlexGridSizer *sizer11 = new wxFlexGridSizer( 4, 2, 0, 0 );
	sizer11->AddGrowableCol( 1 );

	wxStaticText *m_stLabel = new wxStaticText( this, ID_DEFAULT, _("Label"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer11->Add( m_stLabel, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5 );
	m_tcLabel = new wxTextCtrl( this, ID_LABEL, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	sizer11->Add( m_tcLabel, 0, wxALL | wxEXPAND, 5 );

	wxStaticText *m_stShortcut = new wxStaticText( this, ID_DEFAULT, _("Shortcut"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer11->Add( m_stShortcut, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5 );
	m_tcShortcut = new wxTextCtrl( this, ID_LABEL, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	sizer11->Add( m_tcShortcut, 0, wxALL | wxEXPAND, 5 );

	wxStaticText *m_stId = new wxStaticText( this, ID_DEFAULT, _("Id"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer11->Add( m_stId, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5 );
	m_tcId = new wxTextCtrl( this, ID_DEFAULT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	sizer11->Add( m_tcId, 0, wxALL | wxEXPAND, 5 );

	wxStaticText *m_stName = new wxStaticText( this, ID_DEFAULT, _("Name"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer11->Add( m_stName, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5 );
	m_tcName = new wxTextCtrl( this, ID_DEFAULT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	sizer11->Add( m_tcName, 0, wxALL | wxEXPAND, 5 );

	wxStaticText *m_stHelpString = new wxStaticText( this, ID_DEFAULT, _("Help String"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer11->Add( m_stHelpString, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5 );
	m_tcHelpString = new wxTextCtrl( this,ID_DEFAULT, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER );
	...
	m_rbItemKind = new wxRadioBox( this, wxID_ANY, _("Kind"), wxDefaultPosition, wxDefaultSize,
	...
	wxButton *m_bAdd = new wxButton( this, ID_ADDMENUITEM, _("&Add"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer4->Add( m_bAdd, 1, wxALL, 5 );

	wxButton *m_bModify = new wxButton( this, ID_MODIFYMENUITEM, _("&Modify"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer4->Add( m_bModify, 1, wxALL, 5 );

	wxButton *m_bRemove = new wxButton( this, ID_REMOVEMENUITEM, _("&Remove"), wxDefaultPosition, wxDefaultSize, 0 );
	sizer4->Add( m_bRemove, 1, wxALL, 5 );

	sizer1->Add( sizer4, 0, wxEXPAND, 5 );

	wxButton *m_bAddSep = new wxButton( this, ID_ADDSEPARATOR, _("Add &Separator"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	wxButton *m_bUp = new wxButton( this, ID_MENUUP, _("&Up"), wxDefaultPosition, wxDefaultSize, 0 );
...
void MenuEditor::AddChild( long& n, int ident, PObjectBase obj )
{
    for (unsigned int i = 0; i < obj->GetChildCount(); i++)
    {
        ...
        {
            InsertItem( n++, wxString( wxChar(' '), ident * IDENTATION ) + "---",
										wxEmptyString, wxEmptyString, wxEmptyString, wxEmptyString, wxEmptyString, childObj );
        }
        else
        {
            InsertItem( n++, wxString( wxChar(' '), ident * IDENTATION ) + childObj->GetPropertyAsString("label"),
...
void MenuEditor::AddItem( const wxString& label, const wxString& shortcut, const wxString& id,
							const wxString& name, const wxString &help, const wxString &kind )
{
...
void MenuEditor::GetItem( long n, wxString& label, wxString& shortcut, wxString& id,
							wxString& name, wxString& help, wxString& kind, PObjectBase* obj )
{
...
void MenuEditor::AddNewItem()
{
    ...
    switch ( m_rbItemKind->GetSelection() )
    {
        ...
        case 1: kind = "wxITEM_CHECK"; break;
        case 2: kind = "wxITEM_RADIO"; break;
    }
    AddItem( m_tcLabel->GetValue(), m_tcShortcut->GetValue(), m_tcId->GetValue(),
				m_tcName->GetValue(), m_tcHelpString->GetValue(), kind );
    m_tcLabel->SetValue( wxEmptyString );
    m_tcShortcut->SetValue( wxEmptyString );
    m_tcId->SetValue( wxEmptyString );
    m_tcName->SetValue( wxEmptyString );
    m_tcHelpString->SetValue( wxEmptyString );
...
{
    AddItem( "---", wxEmptyString, wxEmptyString, wxEmptyString, wxEmptyString, wxEmptyString );
}
