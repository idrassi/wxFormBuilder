...
package.name = "indctrls-plugin"
-- Set this if you want a different name for your target than the package's name.
local targetName = "indctrls"
-- Set the targets.
package.config["Debug"].target = "indctrlsd"
package.config["Release"].target = "indctrls"
-- Set the kind of package you want to create.
--		Options: exe | winexe | lib | dll
package.kind = "dll"
-- Set the files to include.
package.files = { matchfiles( "*.cpp", "*.h", "*.rc" ) }
...
package.bindir = "wxIndustrialControls"
--package.libdir = "../../lib"
-- Set the defines.
...
if ( OS == "windows" ) then
	if ( options["unicode"] ) then
		...
		{
			"wxmsw"..wx_ver..wx_ver_minor.."umd_indctrls_gcc",
		}
		package.config["Release"].links =
		{
			"wxmsw"..wx_ver..wx_ver_minor.."um_indctrls_gcc",
		}
	else
		package.config["Debug"].links =
		{
			"wxmsw"..wx_ver..wx_ver_minor.."md_indctrls_gcc",
		}
		package.config["Release"].links =
		{
			"wxmsw"..wx_ver..wx_ver_minor.."m_indctrls_gcc",
		}
	end
end
...
dopackage( "../build/wxIndustrialControls" )