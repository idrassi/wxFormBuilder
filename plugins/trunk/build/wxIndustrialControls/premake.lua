--*****************************************************************************
--*	Author:		Jose A. Hurtado <joseantonio.hurtado@gmail.com>
--*	Date:		02/28/2007
--*	Version:	1.00-beta
--*	
--*	NOTES:
...
package.name = "wxIndustrialControls"
...
package.files = { matchfiles( "../../src/wxIndustrialControls/*.cpp", "../../include/wx/wxIndustrialControls/*.h") }
