...
/////////////////////////////////////////////////////////////////////////////
#ifndef __KWX_ANGULAR_METER__
#define __KWX_ANGULAR_METER__

#include "wx/wxIndustrialControls/indctrlsdef.h"

#define MAXSECTORCOLOR 10 // fixme: make the number of sector unlimited

class WXDLLIMPEXP_INDCTRLS kwxAngularMeter : public wxWindow
{
public:
	...
	void SetNumSectors(int nSector) { m_nSec = wxMin(MAXSECTORCOLOR-1,nSector) ; };
