...
public:
  ...
  m_frame(frame)
  {
    ...
    m_border_size = new wxSpinCtrl(this, ID_AUI_PaneBorderSize, wxString::Format(wxT("%d"), m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_PANE_BORDER_SIZE)), wxDefaultPosition, wxSize(50,20), wxSP_ARROW_KEYS, 0, 100, m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_PANE_BORDER_SIZE));
    ...
    m_sash_size = new wxSpinCtrl(this, ID_AUI_SashSize, wxString::Format(wxT("%d"), m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_SASH_SIZE)), wxDefaultPosition, wxSize(50,20), wxSP_ARROW_KEYS, 0, 100, m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_SASH_SIZE));
    ...
    m_caption_size = new wxSpinCtrl(this, ID_AUI_CaptionSize, wxString::Format(wxT("%d"), m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_CAPTION_SIZE)), wxDefaultPosition, wxSize(50,20), wxSP_ARROW_KEYS, 0, 100, m_frame->GetDockArt()->GetMetric(wxAUI_DOCKART_CAPTION_SIZE));
